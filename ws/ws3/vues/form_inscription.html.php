...
<h2 class="alert bg-info">Inscription</h2>
<form method="POST">
    ...
    <button type="submit" class="btn btn-primary" name="submit">Enregistrer
    </button>
    <a href="gestion_voitures.php" class="btn btn-danger float-right">Annuler</a>
</form>
</div>
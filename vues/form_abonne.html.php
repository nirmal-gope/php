...
<form method="POST">
    ...
    <div class="form-group">
        ...
        <select name="niveau" id="niveau" class="form-control">
            ...
            <option selected value=30 <?= !empty($abonne) && $abonne["niveau"] == 10 ? 'selected' : ''; ?>>Bibliothécaire</option>
            <option value=50 <?= !empty($abonne) && $abonne["niveau"] == 10 ? 'selected' : ''; ?>>Administrateur</option>
        </select>
    </div>
